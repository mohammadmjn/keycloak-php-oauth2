...
namespace SSO\OAuth2\Client\Provider;
...
use SSO\OAuth2\Client\Provider\Exception\EncryptionConfigurationException;

class SSO extends AbstractProvider {
    use BearerAuthorizationTrait;

    /**
     * SSO Server URL, eg. http://localhost:8080/auth.
     *
     * @var string
     */
